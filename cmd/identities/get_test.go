				...
				Config: toJson(identity.CredentialsOIDC{Providers: []identity.CredentialsOIDCProvider{
					{
						...
						CurrentAccessToken:  transform(accessToken + "0"),
						CurrentRefreshToken: transform(refreshToken + "0"),
						CurrentIDToken:      transform(idToken + "0"),
					...
					},
					{
						...
						CurrentAccessToken:  transform(accessToken + "1"),
						CurrentRefreshToken: transform(refreshToken + "1"),
						CurrentIDToken:      transform(idToken + "1"),
